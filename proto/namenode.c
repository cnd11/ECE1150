...
#define MY_IP "192.168.1.41" // name node IP
#define PERL_PORT 1501

#define NUM_OF_DATA_NODES 2
#define DATA_NODE_IP_1 "192.168.1.41" // IP of data node 1 (in this case, data node is the name node as well so this is a local IP)
#define DATA_NODE_IP_2 "98.239.240.199" // public IP of data node 2
